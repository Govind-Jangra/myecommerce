      ...
      <div>
        <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
                      ...
                      <div className="flex flex-1 items-end justify-between text-sm">
                        ...
                        <div className="flex">
                          ...
                          <button
                            ...
                            type="button"
                            className="font-medium text-2xl  text-red-700 hover:text-indigo-500 "
                          >
                            Remove
                          </button>
                        </div>
          ...
          <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
            ...
            <div className="mt-6 flex justify-center text-center text-1xl text-gray-500 ">
              <p>
                or 
                <Link to="/">
                  <button
                    type="button"
                    className="font-medium text-indigo-600 hover:text-indigo-500 text-1xl px-2"
                  >
                     Continue Shopping
